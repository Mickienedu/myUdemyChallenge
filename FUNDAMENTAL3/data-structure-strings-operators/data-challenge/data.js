...
const game = {
    ...
    // what he did, using destructuring.
    const [players1, players2] = game.players;
    console.log(players1, players2);  // all the players from 2 teams shown
...
console.log(gk, fieldPlayers);
  ...
  //3
// const allPlayers = [ 'Neuer', 'Pavard', 'Martinez', 'Alaba', 'Davies', 
// 'Kimmich', 'Goretzka', 'Coman', 'Muller','Gnarby', 'Lewandowski', 'Burki', 'Schulz',
// 'Hummels','Akanji','Hakimi','Weigl','Witsel','Hazard','Brandt','Sancho',
// 'Gotze',];

...
//2 3, (2+3)/2 =2.5  SAME AS 2/2+3/2 =2.5. this is how we calculate avg
...
§ Data 2: [16, 6, 10, 5, 6, 1, 4]
GOOD LUCK �*/
const calcAverageHumanAge1 = ages => ages.map(age => 
    (age <= 2 ? 2 * age : 16 + age * 4)).filter(age => age >= 18)

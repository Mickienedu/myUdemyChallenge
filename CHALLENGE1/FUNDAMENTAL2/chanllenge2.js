...
//         return `Dolphin win (${scoreDolphins})`;
//     }else if(scoreKoalas == scoreDolphins) {
//         return `Koalas win (${scoreKoalas})`;
//     }else {
//         return `No team wins`;
//     }
// }
...
const calcAverage = (a, b, c) => (a + b + c) / 3; //point one
...
if(mark.bmi > john.bmi) {
    console.log(`${mark.fulName}'s BMI (${mark.bmi}) is higher than
     ${john.fulName}'s BMI (${john.bmi})`)
}else if (john.bmi > mark.bmi) {
    console.log(`${john.fulName}'s BMI (${john.bmi}) is higher than
    ${mark.fulName}'s BMI (${mark.bmi})`);
}
